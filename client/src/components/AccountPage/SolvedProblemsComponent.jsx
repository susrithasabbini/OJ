  ...
  return (
    <div className="rounded-xl flex-[3] flex md:flex-row flex-col gap-y-4 p-4 shadow-md">
      ...
      <div className="flex-[1] flex flex-col gap-y-2">
        <div className="flex-[1] rounded-xl flex flex-row shadow-md">
          <div className="flex-[1] flex items-center flex-col justify-center p-2">
            <h2 className="text-green-600 min-[1200px]:text-medium text-sm font-bold">
              Easy
            </h2>
        ...
        <div className="flex-[1] rounded-xl flex flex-row shadow-md">
          <div className="flex-[1] flex items-center flex-col justify-center p-2">
            <h2 className="text-amber-500 min-[1200px]:text-medium text-sm font-bold">
              Medium
            </h2>
        ...
        <div className="flex-[1] rounded-xl flex flex-row shadow-md">
          <div className="flex-[1] flex items-center flex-col justify-center p-2">
            <h2 className="text-red-600 min-[1200px]:text-medium text-sm font-bold">
              Hard
            </h2>
